...
namespace ITSTILoopTest
{
    public class CBDCBridgeTest
    {
        ...
        public async Task CanCheckBalances()
        {
            ...
            // Arrange            
            EthereumConfig ethereumConfig = new EthereumConfig() { ContractAddress = "0xa88F7F14d97304f9B694d962E84fCFfe01E729D5", RpcEndpoint = "https://cbdcuser:testTEST11@cbdcethereum.azurewebsites.net/", ContractOwnerKey = "0xb5cc3ddbd4dacedd91eea5994c6cbbcd02b9b8644f89ef4576ce9bad2ae104be" };
        ...
        public async Task CanSettleAccounts()
        {
            ...
            CBDCBridgeService service = new CBDCBridgeService(loggerMock2.Object, eventRetriever, option.Object);
            //var accounts = new List<string>() { "0xE1A6dc4e3Bdb3A8384181a9F70aB76642762557b", "0x34A816710f52a75F4430674a12E2Ad9De1092e86", "0x6a82bf493725771AD037DD0cf1ABa956e73C18ff" };
            var accounts = new Dictionary<string, decimal>() { { "0xE1A6dc4e3Bdb3A8384181a9F70aB76642762557b", 10 }, { "0x34A816710f52a75F4430674a12E2Ad9De1092e86", -5 }, { "0x6a82bf493725771AD037DD0cf1ABa956e73C18ff", -5 } };
