...
namespace ITSTILoopTest
{
    public class CBDCBridgeTest
    {
        ...
        public async Task CanCheckBalances()
        {
            ...
            // Arrange            
            CBDCBridgeEventWatcherConfig ethereumConfig = new CBDCBridgeEventWatcherConfig() { ContractAddress = "0x69282EFd96cd19d747944A9FB358feBaf8c16a2D", RpcEndpoint = "https://cbdcuser:testTEST11@cbdcethereum.azurewebsites.net/", ContractOwnerKey = "0xb5cc3ddbd4dacedd91eea5994c6cbbcd02b9b8644f89ef4576ce9bad2ae104be" };
            ...
            CBDCBridgeService service = new CBDCBridgeService(loggerMock2.Object, eventRetriever, ethConfig.Object);
